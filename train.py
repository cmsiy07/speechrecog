...
class SpeechDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # < fill your code here >
        print("self.dataset_path" + self.dataset_path + self.data[0]['file']))
...
def main():
    ...
    parser.add_argument('--val_list',   type=str, default='/home/EE738/ks_val.json')
    parser.add_argument('--labels_path',type=str, default='/home/EE738/label.json')
    parser.add_argument('--train_path', type=str, default='/home/EE738/kspon_train')
    parser.add_argument('--val_path',   type=str, default='/home/EE738/kspon_eval')
