...
class SpeechRecognitionModel(nn.Module):
    ...
    def __init__(self, n_classes=11):
        ...
        cnns = [nn.Dropout(0.1),  
                nn.Conv1d(40,128,3, stride=1, padding=1),
                nn.BatchNorm1d(128),
                nn.ReLU(),
                nn.Dropout(0.1),  
        ...
        # < fill your code here >
        #changed the dropout rate to be 0.3, hidden layers to 768
        self.lstm = nn.LSTM(128,256,3, bidirectional=True, dropout=0.3, batch_first = True)
...
if __name__ == "__main__":
    ...
    #python local.py --max_epoch 20 --batch_size 32 --save_path test2
    #python local.py --eval --initial_model LR.pt --save_path test3
#C:\Users\Cheryl\Documents\SpeechRecog\speechrecog\local.py
